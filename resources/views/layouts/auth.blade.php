...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('assets/auth/vendors/flag-icon-css/css/flag-icons.min.css')}}">
  ...
  <body> 
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item dropdown border-left">
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{asset('assets/auth/images/faces/face4.jpg')}}" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <img src="{{asset('assets/auth/images/faces/face5.jpg')}}" alt="image" />
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="preview-list">
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="{{asset('assets/auth/images/faces/face6.jpg')}}" alt="image" class="rounded-circle" />
                        </div>
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="{{asset('assets/auth/images/faces/face8.jpg')}}" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="{{asset('assets/auth/images/faces/face9.jpg')}}" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                      ...
                      <div class="preview-item border-bottom">
                        <div class="preview-thumbnail">
                          <img src="{{asset('assets/auth/images/faces/face11.jpg')}}" alt="image" class="rounded-circle" />
                        </div>
                        <div class="preview-item-content d-flex flex-grow">
                          <div class="flex-grow">
                            <div class="d-flex d-md-block d-xl-flex justify-content-between">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel" id="owl-carousel-basic">
                      <div class="item">
                        <img src="{{asset('assets/auth/images/dashboard/Rectangle.jpg')}}" alt="">
                      </div>
                      <div class="item">
                        <img src="{{asset('assets/auth/images/dashboard/Img_5.jpg')}}" alt="">
                      </div>
                      <div class="item">
                        <img src="{{asset('assets/auth/images/dashboard/img_6.jpg')}}" alt="">
                      </div>
                    </div>
                    <div class="d-flex py-4">
                      <div class="preview-list w-100">
                        <div class="preview-item p-0">
                          <div class="preview-thumbnail">
                            <img src="{{asset('assets/auth/images/faces/face12.jpg')}}" class="rounded-circle" alt="">
                          </div>
                          <div class="preview-item-content d-flex flex-grow">
                            <div class="flex-grow">
                              <div class="d-flex d-md-block d-xl-flex justify-content-between">
    ...
    <script src="{{asset('assets/auth/js/proBanner.js')}}"></script>
