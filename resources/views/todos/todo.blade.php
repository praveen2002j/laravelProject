        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Todo Table </h3>
            ...
            @foreach($todos as $todo)
                <tr>
                    ...
                    <td class="py-1">{{ $todo->name }}</td>
                    <td class="py-1">{{ $todo->description }}</td>
                    <td class="py-1">{{ $todo->status ? 'Completed' : 'Pending' }}</td>
                    <td class="py-1">{{ $todo->due_date }}</td>
                    <td class="py-1">
