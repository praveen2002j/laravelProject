        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Update Todo</h3>
            </div>
...
<form lass="forms-sample" method="post" action="{{route('todo.update',['todo' => $todo])}}">
    @csrf
    @method('put')
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="description" placeholder="Description" value="{{$todo->description}}"/>
    </div>
    <div class="form-group">
        <label>Status</label>
        <select class="form-control" name="status" value="{{$todo->status}}">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="date" name="due_date" value="{{$todo->due_date}}" />
    </div>
    <div>
